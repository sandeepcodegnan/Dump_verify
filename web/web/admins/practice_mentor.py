...
class PracticeMentors(Resource):
    def __init__(self):
        super().__init__()
        ...
        self.collection = get_collection('practice_mentors')
        ...
        <body>
            <div class="container">
                <div class="content">
                    ...
                    <p>Hello, {name},</p>
                    <p>Congratulations on joining our team as a Practice-Mentor/Trainer!</p>
    ...
    def post(self):
        ...
        return {"message": "Practice-Mentor signup successful"}, 201
    ...
    def put(self):
        ...
        return {"message": "Practice-Mentor updated successfully", "Mentor": updated_mentor}, 200
    ...
    def delete(self):
        ...
        return {"message": "Practice-Mentor deleted successfully"}, 200
